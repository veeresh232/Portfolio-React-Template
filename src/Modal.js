...
const Modal = ({id,label,title,imgUrl}) => {
  return (
    <div className="portfolio-modal modal fade" id={id} tabindex="-1" aria-labelledby={label} aria-hidden="true">
                ...
                <div className="container">
                    <div className="row justify-content-center">
                        <div className="col-lg-8">
                            ...
                            <img className="img-fluid rounded mb-5" src={imgUrl} alt="..." />
